    ...
    <div className="mb-6">
        <div className="flex items-start space-x-6 bg-blue-950/20 transition-all duration-300 p-4 sm:p-8 rounded-md">
            ...
            <div className="flex-1">
                ...
                <p className="text-gray-200 text-sm sm:text-base pt-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officia, iusto possimus molestias, est alias cupiditate velit libero assumenda ipsa obcaecati praesentium quia ipsam consequuntur ea facilis nobis officiis deleniti. Earum!</p>
            </div>
        </div>
    </div>
  )
